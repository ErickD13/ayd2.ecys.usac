 ...
 * @author erick
 */
public class UpdatedObserver implements Observer, DisplayElement {
    ...
    public UpdatedObserver(ObservableElement element) {
    ...
    public void update(String event, String type, String id) {
        if("modificado".equalsIgnoreCase(event) && !"".equals(type) && !"".equals(id)){
            this.event = event;
            this.type = type;
            this.id = id;
            display(true);
